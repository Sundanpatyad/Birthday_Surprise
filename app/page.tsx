...
export default function BirthdayPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-pink-400 via-purple-400 to-indigo-300 flex flex-col items-center justify-center text-white overflow-hidden p-4 relative">
      <FloatingHearts />
      ...
      <AnimatePresence mode="wait">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {shownImages.map((num) => (
                <motion.div
                  ...
                  className="relative w-48 h-48 sm:w-56 sm:h-56 group"
                >
                  <Image
        ...
        {stage === "birthday" && showMessages && (
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            className="text-center max-h-screen overflow-y-auto"
          >
            <motion.h1
              initial={{ scale: 0.5 }}
              animate={{ scale: 1 }}
            ...
            <motion.div className="space-y-6 mt-8">
              <motion.div
                className="relative w-48 h-48 sm:w-64 sm:h-64 mx-auto mb-8 group"
              ...
              {messages.map((message, index) => (
                ...
                >
                  <motion.p
                    className="text-xl sm:text-2xl md:text-3xl text-white drop-shadow-lg bg-pink-400/20 backdrop-blur-sm rounded-xl p-4"
